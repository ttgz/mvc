    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="san-pham">
                    <a href="#san-pham">Sản phẩm</a>
                                ...
                                <a href="#san-pham-GETapi-v1-products--product_id-">API lấy thông tin chi tiết sản phẩm</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="san-pham-PUTapi-v1-products--product_id-">
                                <a href="#san-pham-PUTapi-v1-products--product_id-">API cập nhật thông tin sản phẩm</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Tên sản phẩm. Bắt buộc. Example: <code>consequatur</code></p>
                    ...
                    <h2 id="san-pham-GETapi-v1-products--product_id-">API lấy thông tin chi tiết sản phẩm</h2>
...
<code class="language-json" style="max-height: 300px;">{
  ...
  &quot;message&quot;: &quot;Thực hiện th&agrave;nh c&ocirc;ng&quot;,
  &quot;data&quot;: {
    // Th&ocirc;ng tin chi tiết của sản phẩm (theo ProductResource)
  }
}</code>
 </pre>
    </span>
...
<p>ID sản phẩm. Example: <code>1</code></p>
                    ...
                    <h2 id="san-pham-PUTapi-v1-products--product_id-">API cập nhật thông tin sản phẩm</h2>
...
<i>optional</i> &nbsp;
               ...
               data-component="body">
    <br>
<p>Tên sản phẩm. Không bắt buộc. Example: <code>consequatur</code></p>
        </div>
        </form>
